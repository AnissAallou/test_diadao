...
/**
       * détecter IE
       * renvoie la version d'IE ou false, si le navigateur n'est pas Internet Explorer
       */
      function detectIE() {
      ...
      $(function() {
        ...
        // Ajuster la hauteur de la vidéo lorsque la fenêtre est redimensionnée
        ...
        $(window).on("load scroll resize", function() {
          ...
          ); // parallax (25% taux de défilement)
        });

        // Fond d'image de parallaxe
